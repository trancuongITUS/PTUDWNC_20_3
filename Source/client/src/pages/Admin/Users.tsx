...
import { deleteUser, getAllUsers, lockUser, unlockUser } from '../../services/userApi';
                        ...
                        <tr key={user.id}>
                            ...
                            <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                <div className="flex items-center space-x-3.5">
                                    ...
                                    {/* <button onClick={() => handleDeleteAccount(user.id)} className="hover:text-primary" title="Delete User">
                                        <svg
                                        className="fill-current"
                                        width="18"
                                        height="18"
